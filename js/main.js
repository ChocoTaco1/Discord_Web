$(document).ready(function () {
    ...
    function updateView(data){
        ...
        $serverStatContainer.html('<div style="text-shadow: -1px 1px 1px #111111;line-height: 17px;font-size:13px; color:#0fcfb9;text-align: center; font-family: sans-serif;">'+ template + '</div>');
    }
