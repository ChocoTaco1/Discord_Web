$(document).ready(function () {
    ...
    function updateView(data){
        ...
        $serverStatContainer.html('<div bgcolor="" style="padding: 0px 0px 0px 0px;text-shadow: -1px 1px 1px #111111;line-height: 18px;font-size:14px; color:#07bec0;text-align: right; font-family: sans-serif;mso-height-rule: exactly">'+ template + '</div>');
    }
