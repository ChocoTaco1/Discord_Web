$(document).ready(function () {
    ...
    function updateView(data){
        ...
        $serverStatContainer.html('<div bgcolor="#222528" style="text-shadow: -1px 1px 1px #111111;line-height: 16px;font-size:13px; color:#0fcfb9;text-align: right; font-family: sans-serif;">'+ template + '</div>');
    }
